...
const compatible:ClientCompatibility={clientVersion:"0.8.39",clientProtocol:6,minimumVersion:"0.8.36",recommendedVersion:"0.8.39",serverProtocol:6,serverVersion:"0.8.39",serverCapabilities:["readable-generation-v1","external-delete-proof-v1"],compatible:true,updateAvailable:false,reason:null};
